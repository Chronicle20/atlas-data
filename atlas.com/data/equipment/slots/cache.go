...
func (e *equipmentSlotCache) attemptRead(id string, itemId uint32) (Model, error) {
	var equipment Model
	e.mutex.RLock()
...
func (e *equipmentSlotCache) attemptLoad(tenant tenant.Model, id string, itemId uint32) (Model, error) {
	var equipment Model
	e.mutex.Lock()
...
func (e *equipmentSlotCache) GetEquipmentSlot(tenant tenant.Model, itemId uint32) (Model, error) {
	var equipment Model
